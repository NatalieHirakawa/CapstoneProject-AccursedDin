...
namespace PlayerController2D {
    /// Based off Tarodev's Controller
    /// with minor tweaks by Chris W
    ...
    public class PlayerController : MonoBehaviour {
        ...
        // colliders are not fully established when update starts...
        ...
        private void RunCollisionChecks()
        {
            ...
            //crappy slope adjustment; just dont use slopes for now
            /*const float adj = -0.5f;
            RaycastHit2D Hit2D = Physics2D.Raycast(transform.position, Vector2.down, _characterBounds.max.y, _groundLayer);
            if(Hit2D != false)
            {
                Vector2 t = transform.position;
                t.y = Hit2D.point.y+_characterBounds.max.y+ adj;
        ...
        private void CalculateWalk()
        {
            ...
            //flip character
            if(_currentHorizontalSpeed * transform.localScale.x < 0)
            {
